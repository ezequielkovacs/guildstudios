...
class Members extends React.Component {
  ...
  render(){
    ...
    return(
      ...
      actions={[<Icon type="mail" />, <Icon type="customer-service" />, <Icon type="instagram" />, <Icon type="bulb" />]}
            >
            <Meta
        ...
        description="DJ and Producer"
          ...
          actions={[<Icon type="mail" />, <Icon type="flag" />, <Icon type="database" />, <Icon type="link" />]}
            >
            <Meta
